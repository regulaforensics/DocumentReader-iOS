...
# Basic RFID Only Sample Project (iOS)
...
Sample project in Swift, demonstrating RFID-only reading with the Document Reader SDK. Also includes the sample UI implementation.
...
2. Open the `RFIDOnly-sample.xcworkspace` workspace in Xcode.
3. Run pods `pod install`.
4. Add the license file to the target:
    ...
    - Copy the license file to the project: `Basic/DocumentReaderRFIDOnly-sample/RFIDOnly-sample/`.
