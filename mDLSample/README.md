...
# Document Reader SDK Mobile Driver's License Processing Sample Project (iOS)
...
Sample project in Swift, demonstrating how to set up and use the <a target="_blank" href="https://docs.regulaforensics.com/develop/doc-reader-sdk/mobile/getting-started/mdl/">Mobile Driver's License Processing</a> feature.
...
2. Open the `mDLSample` project in an IDE.
...
4. Add license file to the target:
    ...
    - Copy the license file to the project: `mDLSample/mDLSample/`
